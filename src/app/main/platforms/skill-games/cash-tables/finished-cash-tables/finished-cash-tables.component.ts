...
@Component({
  ...
  templateUrl: './finished-cash-tables.component.html',
  styleUrls: ['./finished-cash-tables.component.scss']
})
export class FinishedCashTablesComponent extends BasePaginatedGridComponent implements OnInit {
  public path = 'cashtable/inactive';
  public rowData = [];
  ...
  constructor(protected injector: Injector, private _snackBar: MatSnackBar,
    ...
    super(injector);
    this.adminMenuId = GridMenuIds.SG_CASH_TABLES_FINISHED;
    this.columnDefs = [
