...
@Component({
  ...
  templateUrl: './finished-cash-table.component.html',
  styleUrls: ['./finished-cash-table.component.scss']
})
export class FinishedCashTableComponent extends BasePaginatedGridComponent implements OnInit {
  public path = 'cashtable/viewinactive';
  public id;
