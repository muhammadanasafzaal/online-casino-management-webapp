...
@Component({
  selector: 'app-mapped-sports',
  templateUrl: './mapped-sports.component.html',
  styleUrls: ['./mapped-sports.component.scss']
})
export class MappedSportsComponent extends BasePaginatedGridComponent implements OnInit {
  ...
  ngOnInit() {
    this.gridStateName = 'mapped-sport-grid-state';
    this.getProviders();
  }
